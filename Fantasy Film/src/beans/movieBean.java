...
public class movieBean {
	...
	ArrayList<String> dec2017 = new ArrayList<String>(Arrays.asList("24 Hours to Live", "Gangster Land", "Love Beats Rhymes", "The Other Side of Hope", "Tribes of Palos Verdes", "Wonder Wheel", "The Disaster Artist", "Just Getting Started", "Hollow in the Land", "I, Tonya", "November Criminals", "Quest", "Ferdinand", "The Shape of Water", "Star Wars: The Last Jedi", "The Ballad of Lefty Brown", "Beyond Skyline", "Gotti", "The Greatest Showman", "Jumanji: Welcome to the Jungle", "All the Money in the World", "Downsizing", "Father Figures", "Pitch Perfect 3", "Crooked House", "Hangman", "Happy End", "Hostiles", "The Post", "Molly's Game", "Phantom Thread", "Film Stars Don't Die in Liverpool"));
	ArrayList<String> jan2018 = new ArrayList<String>(Arrays.asList("Insidious: The Last Key", "The Strange Ones", "The Commuter", "Paddington 2", "Proud Mary", "12 Strong", "Den of Thieves", "Forever My Girl", "The Leisure Seeker", "Extinction", "Maze Runner: The Death Cure", "White Boy Rick"));
